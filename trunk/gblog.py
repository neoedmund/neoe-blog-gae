...
class BloggerExample:
  ...
  def CreatePost(self, title, content, author_name, is_draft, postdate=None):
    ...
    if postdate:
	    entry.published = atom.Published(text=postdate)
	    # eg. "2003-12-13T18:30:02+01:00"
